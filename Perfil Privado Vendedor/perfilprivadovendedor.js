document.addEventListener("DOMContentLoaded", function () {
    ...
    editProfessionBtn.addEventListener("click", function () {
      ...
      // Agregar event listener para el evento keydown
      newProfessionInput.addEventListener("keydown", function (event) {
        if (event.key === "Enter") {
    ...
    function createEditableElement(originalElement) {
      ...
      const newElement = document.createElement(elementType === "div" ? "textarea" : "input");
    ...
    function applyStyles(inputElement, targetElement) {
      ...
      inputElement.style.backgroundColor = window.getComputedStyle(targetElement).backgroundColor;
