...
const limiteCaracteresTitulo = 100;

// Límite de caracteres para la descripción
const limiteCaracteresDescripcion = 150;
...
infopubliContainers.forEach(function (infopubliContainer) {
  ...
  if (tituloElement.innerText.length > limiteCaracteresTitulo) {
    const tituloTruncado =
      tituloElement.innerText.substring(0, limiteCaracteresTitulo - 3) + '...';
  ...
  if (descripcionElement.innerText.length > limiteCaracteresDescripcion) {
    const descripcionTruncada =
      descripcionElement.innerText.substring(
        0,
        limiteCaracteresDescripcion - 3
      ) + '...';
